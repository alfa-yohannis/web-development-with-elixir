defmodule HiwiWeb.Layouts do
  ...
  # HIWI
  attr :user, :any, default: nil, doc: "the current logged-in user (if any)"
  ...
  ## ===== LIVE LAYOUT COMPONENT (used as <.live> in .heex) =====

  @doc "Layout component for LiveViews, used as <.live>...</.live>."
